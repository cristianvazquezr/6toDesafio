...
class userMananger{
    ...
    async addUser(first_name,last_name, email, age, password,admin){
        //creo un objeto nuevo con atributos nuevos
        let user1= {first_name:first_name,last_name:last_name,email:email,age:age,password:createHash(password),admin:admin}
        //creo un array con los valores de ese nuevo objeto
        let valores =[user1.first_name,user1.last_name,user1.email,user1.age,user1.password,user1.admin]
